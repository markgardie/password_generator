...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.resizable(False, False)
        self._history_window = None  # посилання на вікно історії
        self.setup_ui()

    def setup_ui(self):
        self.grid_columnconfigure(0, weight=1)

        # --- Заголовок + перемикач теми ---
        ...
        # --- Кнопки генерації та збереження ---
        buttons_frame = ctk.CTkFrame(self, fg_color="transparent")
        buttons_frame.grid(row=6, column=0, padx=24, pady=(0, 8), sticky="ew")
        ...
        # --- Кнопка відкрити історію ---
        self.history_btn = ctk.CTkButton(
            self,
            text="Переглянути збережені паролі",
            font=ctk.CTkFont(size=13),
            height=36,
            fg_color="transparent",
            border_width=1,
        ...
        self.history_btn.grid(row=7, column=0, padx=24, pady=(0, 8), sticky="ew")
        ...
        self.status_label.grid(row=8, column=0, padx=24, pady=(0, 16))
    ...
    def on_generate(self):
        ...
        self._set_status("")
        self._animate_password(password)
    ...
    def _animate_password(self, final_password, step=0):
        ...
        if step < ANIMATION_STEPS:
            ...
            self.after(
                ANIMATION_DELAY,
                lambda: self._animate_password(final_password, step + 1),
            )
        else:
            # Фінальний крок — справжній пароль
            self.password_entry.delete(0, "end")
